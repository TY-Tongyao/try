...
parser.add_argument('--ddpm_steps', type=int, default=1000, help='Number of DDPM steps')
parser.add_argument('--ddpm_dim', type=int, default=64, help='DDPM latent dimension')
...
if __name__ == '__main__':
    ...
    for run in range(args.runs):
        ...
        ddpm = DDPM(latent_dim=args.ddpm_dim, num_steps=args.ddpm_steps).to(device)
        ...
        for epoch in range(args.num_epoch):
            ...
            for batch_idx in range(batch_num):
                ...
                # Apply DDPM loss (or any other modifications required by DDPM)
                ddpm_loss = ddpm.loss(subgraph_embed, subgraph_embed_hat)  # Replace with actual DDPM loss function if different
            ...
            mean_loss = (total_loss * batch_size + total_loss * cur_batch_size) / nb_nodes
